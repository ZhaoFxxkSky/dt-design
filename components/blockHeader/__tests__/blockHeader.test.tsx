...
import type { IBlockHeaderProps } from '../index';
...
describe('test BlockHeader render', () => {
  ...
  it('should render BlockHeader props default in BlockHeader', () => {
  ...
  it('should render BlockHeader test click event', () => {
  ...
  it('should render content class and style', () => {
    render(
      <BlockHeader title="测试" contentStyle={{ height: 200 }} contentClassName="custom__content">
        <div>Hello World!</div>
      </BlockHeader>,
    );
  ...
  it('should render BlockHeader background false success', () => {
  ...
  it('should render BlockHeader correct dom length', () => {
    ...
    const { container: container1 } = render(<BlockHeader title="分类级别" description="测试" />);
