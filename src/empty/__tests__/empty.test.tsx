...
describe('Empty', () => {
    ...
    it('should render SearchIcon and LoupeIcon when type is search and active is true', () => {
        ...
        expect(container.querySelector('.dt-empty__search')).toBeInTheDocument();
        expect(container.querySelector('.dt-empty__loupe')).toBeInTheDocument();
    });
    ...
    it('should render SearchIcon and LoupeIcon when type is search and active is false', () => {
        ...
        expect(container.querySelector('.dt-empty__search')).toBeFalsy();
        expect(container.querySelector('.dt-empty__loupe')).toBeFalsy();
    });
    ...
    it('should not show content when empty', () => {
        ...
        expect(container.querySelector('.dt-empty')?.classList).toContain('ant-empty');
    });
