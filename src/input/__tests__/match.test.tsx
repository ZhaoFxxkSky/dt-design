...
describe('Test Input.Match component', () => {
    ...
    it('Should support searchType', () => {
        ...
        const elements = container.querySelectorAll('span.dt-input-match-suffixItem')!;
        ...
        expect(container.querySelectorAll('span.dt-input-match-suffixItem')!).toHaveLength(4);
        expect(
            container.querySelectorAll('span.dt-input-match-suffixItem')[0].classList
        ).toContain('dt-input-match-suffixItem__active');
        fireEvent.click(container.querySelectorAll('span.dt-input-match-suffixItem')[0]);
    ...
    it('Should support filterOptions', () => {
        ...
        expect(container.querySelectorAll('span.dt-input-match-suffixItem')!).toHaveLength(1);
    });
