...
\`\`\`
        ...
        const renderBody = container.querySelector<HTMLDivElement>('.dt-markdown-render-body');

        expect(renderBody).not.toBeNull();
        expect(renderBody?.className).toContain('dt-vs-dark');
    });
...
\`\`\`
    ...
    it('Should render empty value', () => {
        ...
        expect(container.querySelector('.dt-markdown-render-body')?.innerHTML).toBe('');
    });
});
