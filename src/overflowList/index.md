...
<code src="./demos/collapse-direction.tsx" title="折叠方向" description="支持 `collapseFrom` 设置折叠方向。"></code>
<code src="./demos/min-visible-items.tsx" title="最小展示的数目" description="支持 `minVisibleItems` 设置最小展示的数目。。"></code>
