...
export const RulesController = <T,>(props: IProps<T>) => {
    ...
    const renderCondition = (
        ...
        if (item?.children?.length) {
            ...
            return (
                <div
                    key={item.key}
                    className={classnames('dt-ruleController__condition', {
                        'dt-ruleController__condition--active': item.children.length > 1,
                    })}
                >
                    <div
        ...
        // 渲染自定义的 component
        return (
            <div className="dt-ruleController__item" key={item.key}>
                {value?.children && (
                    <span
                        className={classnames('dt-ruleController__item--line', {
                            disabled,
                        })}
                    />
                )}
                <div className="dt-ruleController__item--component">
                    {component({
                        rowKey: item.key,
                        disabled: composeDisabled,
                ...
                {!composeDisabled && (
                    <div className="dt-ruleController__item--operation">
    ...
    return (
        <div className={classnames('dt-ruleController', className)} style={style}>
