...
describe('Test Form.Table Component', () => {
    ...
    it("Should render required on columns' title", () => {
        ...
        expect(rows[0].querySelector('.dt-form__table__column--required')).not.toBeNull();
        expect(rows[1].querySelector('.dt-form__table__column--required')).toBeNull();
        expect(rows[2].querySelector('.dt-form__table__column--required')).not.toBeNull();
        expect(rows[3].querySelector('.dt-form__table__column--required')).toBeNull();
    });
});
