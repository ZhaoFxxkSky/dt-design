...
const CollapsibleActionItems: React.FC<ICollapsibleActionItems> = (props) => {
    ...
    const getActionItemNode = (item: ActionItem, isCollapse = false) => {
        ...
        if (!isCollapse)
            return (
                <span
                    className="dt-collapsibleActionItems__btn"
                    key={item.key}
    ...
    return (
        <div className={classNames('dt-collapsibleActionItems', className)} style={style}>
            ...
            {dropdownMenu && (
                <Dropdown
                    ...
                    {...dropdownProps}
                >
                    <a className="dt-collapsibleActionItems__icon">{collapseIcon}</a>
                </Dropdown>
            )}
        </div>
    );
