...
describe('test Drawer ', () => {
    ...
    test('should render mask/maskClosable correct', () => {
        const { unmount } = render(<Drawer open>Hello World</Drawer>);
        const dom = document.querySelector('.dt-drawer-mask');
        expect(dom).toBe(null);
        unmount();
        const fn = jest.fn();
        render(
        ...
        const domMask = document.querySelector('.dt-drawer-mask');
        const domIcon = document.querySelector('.dt-drawer-header--icon');
    ...
    test('should render width correct', () => {
        ...
        expect(document.querySelector('.dt-drawer-content-wrapper')).toHaveStyle({
            width: '640px',
        });
    });
    ...
    test('should render className/style correct', () => {
        ...
        expect(document.querySelector('.dt-drawer')).toHaveClass('root-className');
        expect(document.querySelector('.dt-drawer-body')).toHaveClass('body-className');
        expect(document.querySelector('.dt-drawer')).toHaveStyle({ color: 'red' });
        expect(document.querySelector('.dt-drawer-body')).toHaveStyle({
    ...
    test('should render tab correct', () => {
        ...
        expect(document.querySelector('.dt-drawer-tabs')).not.toBe(null);
    ...
    test('should render from type', () => {
        ...
        const mask = document.querySelector('.dt-drawer-mask');
